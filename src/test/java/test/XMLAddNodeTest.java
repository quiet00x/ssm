...
public class XMLAddNodeTest {
	...
	public static void main(String[] args) throws BusinessException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		...
		String desc = "ResourceObjectList";
		Document doc = MyXMLUtils.loadDocument(xmlPath);
		Element root = doc.getRootElement();
		Iterator ite = root.elementIterator();
		while (ite.hasNext()) {
			Element book = (Element) ite.next();
		}
//		
//		SetVisitor visitor = new SetVisitor();
//		Map<String, Object> reqParams = initQueryParams();
//		System.out.println(reqParams);
//		visitor.setParams(reqParams);
//		root.accept(visitor);
